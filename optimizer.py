...
def main():
    ...
    if not host:
        console.print(
            "[yellow]No host provided. Please enter your UniFi controller IP address.[/yellow]"
        )
        return
    ...
    while True:
        ...
        if choice == "1":
            ...
            console.print(
                "[dim]Tip: Start with Expert Analysis, then use Analyze and Apply for changes.[/dim]\n"
            )
            break
        else:
