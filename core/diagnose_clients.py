...
from core.client_health import ClientHealthAnalyzer, display_client_health_report, analyze_client_health
...
# Show detailed problem analysis for each client
  python3 diagnose_clients.py --host https://YOUR_CONTROLLER_IP --username admin --detailed
    ...
    parser.add_argument('--detailed', action='store_true', 
                       help='Show detailed per-client analysis')
    ...
    if args.profile:
        ...
        if creds:
            ...
            console.print("[dim]Tip: Save a default profile using optimize_network.py --save-profile default[/dim]")
            return 1
    else:
            ...
            if scores:
                ...
                for i, client in enumerate(scores, 1):
                    ...
                    table.add_row(
                        ...
                        str(client['disconnect_penalty']//5) if client['disconnect_penalty'] > 0 else '-',
